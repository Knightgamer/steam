...
const Navbar = () => {
  ...
  return (
    <div className="text-white flex justify-between h-24 mx-auto px-4">
      ...
      <div onClick={handleNav} className="mt-5 block md:hidden">
        {nav ? <AiOutlineClose size={24} /> : <RiMenu3Fill size={24} />}
      </div>

      <ul
        className="fixed left-0 top-0 w-[60%] h-full border-r border-r-gray-900 bg-[#000300] ease-in-out duration-700"
